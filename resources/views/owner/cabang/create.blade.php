...
<div class="form-card">
    <form action="{{ route('owner.cabang.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nama_cabang" name="nama_cabang" class="form-control" placeholder="Contoh: Teh Mur Sudirman" required>
        </div>

        <div class="form-group">
            <label for="alamat">Alamat Lengkap</label>
            <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Masukkan alamat cabang..." required></textarea>
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
            <div class="form-group">
                <label for="latitude">Latitude</label>
                <input type="number" step="any" id="latitude" name="latitude" class="form-control" placeholder="Contoh: 0.507068" required>
            </div>
            
            <div class="form-group">
                <label for="longitude">Longitude</label>
                <input type="number" step="any" id="longitude" name="longitude" class="form-control" placeholder="Contoh: 101.447579" required>
            </div>
        </div>

        <div class="form-group">
            <label for="radius_meter">Radius Validasi Absen (Meter)</label>
            <input type="number" id="radius_meter" name="radius_meter" class="form-control" value="100" min="10" required>
        ...
        <div class="form-group">
            ...
            <input type="email" id="email" name="email" class="form-control" placeholder="Contoh: sudirman@tehmur.com" required>
            <small class="help-text">Digunakan oleh cabang untuk login ke terminal kiosk.</small>
        </div>

        <div class="form-group">
            <label for="password">Password Login Cabang</label>
            <input type="password" id="password" name="password" class="form-control" placeholder="Masukkan password..." required>
        </div>

        <div class="form-group">
            <label for="pin_tambah_karyawan">PIN Kiosk (Untuk Tambah Karyawan)</label>
            <input type="text" maxlength="6" pattern="\d{6}" id="pin_tambah_karyawan" name="pin_tambah_karyawan" class="form-control" placeholder="Contoh: 123456" required>
        ...
        <div style="display: flex; gap: 1rem; margin-top: 2rem;">
            <button type="submit" class="btn-submit">Simpan Cabang</button>
